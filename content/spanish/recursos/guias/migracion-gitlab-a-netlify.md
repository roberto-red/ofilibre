...
image: /resources/guides/migracion-gitlab-a-netlify/netlify-logo.png
date: 2025-02-27
type: guides
...
collections:
  - name: 'blog'
    ...
    fields:
      ...
      - { label: 'Logo (cuadrado)', name: 'thumb', widget: 'image', default: '/images/logo-ofilibre.png'}
  ...
  - name: 'pres'
    ...
    create: true
    slug: '{{slug}}'
    media_folder: '/../../../static/resources/presentations/{{slug}}'
    public_folder: ''
    editor:
      preview: true
    fields:
