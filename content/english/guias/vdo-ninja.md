...
When streaming Cafes con OfiLibre chats with guests via video call we are using the obs resource called vdo.ninja: it’s a technology that enables secure real-time communication between web browsers.
